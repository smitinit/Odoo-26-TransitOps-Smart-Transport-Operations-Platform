...
export function DataTable({
  ...
  // TanStack Table returns unstable function identities; React Compiler skips memoizing it.
  // eslint-disable-next-line react-hooks/incompatible-library -- required by @tanstack/react-table
